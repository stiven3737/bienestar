...
if (formulario) {
    formulario.addEventListener('submit', function(e) {
        ...
        if (editandoId) {
            ...
            const nuevoPaciente = {
                id: Date.now().toString(), // ID único temporal para el LocalStorage
                nombre: nombreInput,
            ...
            // ======================================================
            // 🔥 ENVIAR LOS DATOS AL BACK-END DE SPRING BOOT (JAVA)
            // ======================================================
            fetch('/api/pacientes', {
                method: 'POST',
                headers: {
            ...
            .then(response => {
                if (response.ok) {
                    alert("¡Paciente registrado con éxito en la Base de Datos Clínica!");
                } else {
                    alert("Hubo un problema en el servidor clínico.");
